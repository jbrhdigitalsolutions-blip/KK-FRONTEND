...
for(const marker of ["familyFilters","selectFiltered","Essential design","No coding agent required","buildPageButton","downloadProjectButton"]) assert.ok(designExplorer.includes(marker),`Design Explorer marker missing: ${marker}`);
